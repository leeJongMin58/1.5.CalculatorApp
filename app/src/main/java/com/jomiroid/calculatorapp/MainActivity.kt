package com.jomiroid.calculatorapp
...
import com.jomiroid.calculatorapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun operatorClicked(view: View) {
        ...
        if(operatorText.isNotEmpty()) {
            Toast.makeText(this, "연산자는 연속으로 입력할수 없습니다.", Toast.LENGTH_SHORT).show()
            return
        }
